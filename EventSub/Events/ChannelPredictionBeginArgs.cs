...
namespace ProtoSim.OmniTwitch.EventSub.Events {
	/// <summary>
	/// Provides a set of parameters related to a ChannelPredictionBegin event.
	/// </summary>
	public class ChannelPredictionBeginArgs : EventArgs {
		/// <summary>
		...
		/// <summary>
		/// Creates a new default instance of ChannelPredictionBeginArgs.
		/// </summary>
		public ChannelPredictionBeginArgs() { }

		/// <summary>
		/// Creates a new instance of ChannelPredictionBeginArgs with the provided values.
		/// </summary>
		public ChannelPredictionBeginArgs(string predictionId, string broadcasterUserId, string broadcasterUsername, string broadcasterDisplayName, string title, (string Id, string Title, string Color, int Users, int ChannelPoints, List<(string UserId, string UserUsername, string UserDisplayName, int ChannelPointsWon, int ChannelPointsUsed)> TopContributers) outcomes, string startedAt, string locksAt) {
