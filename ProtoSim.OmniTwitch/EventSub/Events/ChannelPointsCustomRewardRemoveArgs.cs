...
namespace ProtoSim.OmniTwitch.EventSub.Events {
    /// <summary>
	/// Provides a set of parameters related to a ChannelPointsCustomRewardRemove event.
	/// </summary>
	public class ChannelPointsCustomRewardRemoveArgs : EventArgs {
        /// <summary>
		/// Gets the Reward Id.
		/// </summary>
