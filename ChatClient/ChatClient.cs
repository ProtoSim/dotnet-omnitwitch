...
namespace ProtoSim.OmniTwitch {
	...
	public class ChatClient : IDisposable {
        ...
        private readonly System.Timers.Timer _timerPing = new(1000 * 60 * 10) { AutoReset = true, Enabled = false };
        ...
        private static void LogLine(string? text, LogLevel logLevel) {
            ...
            Debug.WriteLine($"[{DateTime.UtcNow.TimeOfDay}] OmniTwich.ChatClient: {text}", logLevel.ToString()); // change to local time
        }
