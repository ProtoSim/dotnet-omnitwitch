namespace ProtoSim.OmniTwitch {
    /// <summary>
    /// Provides a set of parameters related to a raid event.
    /// </summary>
    public class RaidArgs : EventArgs {
        /// <summary>
        ...
        /// <summary>
        /// Gets an integer value representing the viewer count.
        /// </summary>
        public int ViewerCount { get; private set; }

        internal RaidArgs(string? channelName, string? channelId, string? username, string? userDisplayName, string? userId, string? userColorHex, bool isSubscriber, bool isModerator, bool isBroadcaster, int viewerCount) {
