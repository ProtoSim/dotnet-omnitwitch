namespace ProtoSim.OmniTwitch {
    ...
    public class ChatMessageArgs : EventArgs {
        ...
        internal ChatMessageArgs(string? channelName, string? channelId, string? username, string? userDisplayName, string? userId, string? userColorHex, bool isSubscriber, bool isModerator, bool isBroadcaster, string? messageId, string? message) {
